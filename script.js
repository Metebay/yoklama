...
let attendanceRecords = JSON.parse(localStorage.getItem('attendanceRecords')) || []; // Boş dizi olarak başlat
...
function takeAttendance() {
    ...
    if (classId && attendance.length) {
        ...
        // Yoklama kaydını eklemeden önce kontrol et
...
function displayAttendanceRecords() {
    ...
    // Eğer attendanceRecords bir dizi değilse, boş dizi olarak ayarla
    if (!Array.isArray(attendanceRecords)) {
        attendanceRecords = [];
    }
